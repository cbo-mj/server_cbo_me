...
$(document).ready(function() {
	...
	$('.SessionsbyHour').jBox('Tooltip'); $('.TotalVisitors').jBox('Tooltip'); $('.PageViews').jBox('Tooltip'); $('.NewVisitors').jBox('Tooltip'); $('.BounceRate').jBox('Tooltip'); $('.AvgPagesViewed').jBox('Tooltip'); $('.AvgTime').jBox('Tooltip');
});
