...
$(document).ready(function() {
	...
	$.fn.dataTableExt.oSort['nullable-desc'] = function(a,b) {
        ...
        jQuery("#call_tracking_record").promise().done(function() {
            ...
            var t = '<h4 class="head_title">Keywords Rank</h4>';
    ...
    function a() {
        ...
        jQuery("#call_tracking_record tbody tr").each(function() {
            ...
            if (-1 == jQuery.inArray(s[1], e)) {
                ...
                for (var o = 0; 11 >= o; o++) 79 == s[0].indexOf(i[o]) && (a[o] += 1); if (console.log(e.length), "Abandoned" == jQuery(this).find(".call_data").text())
