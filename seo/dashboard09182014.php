...
AmCharts.themes.none={};var nav=$("#nav"),selection=$(".select"),select=selection.find("li");nav.click(function(e){nav.hasClass("active")?($(".menu_container").hide(),nav.removeClass("active"),selection.stop().slideUp(200)):(nav.addClass("active"),$(".menu_container").show(),selection.stop().slideDown(200)),e.preventDefault()}),select.click(function(){select.removeClass("active"),$(this).addClass("active"),nav.trigger("click")});
</script>
<style>
.filter-form {
    width: 365px;
...
<style>
	...
	<?php 
		 ...
		 $mobile = round($total_device_count[3]*100/$total_val) + round($total_device_count[1]*100/$total_val);
		 $mobile2 = ".{$mobile}";
		 $mobile3 = 360 * $mobile2;
	?>	
	...
	#tablet {
	<?php 
		 $tablet = round($total_device_count[1]*100/$total_val);
		 $tablet2 = ".{$tablet}";
		 $tablet3 = 360 * $tablet2;
	?>	
...
?>
    ...
    <div class="piechart2">
        ...
        <div id="<?php echo $device_name[3]; ?>" class="chart_holder2"></div>
        <h1><?php echo round($total_device_count[3]*100/$total_val).'%<br/>'; ?></h1>
        <h6 class="device_name"><?php echo $device_name[3]; ?></h6>
    </div>
    <div class="piechart2"> 
