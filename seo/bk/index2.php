...
const REDIRECT_URL = 'http://localhost/project/shane/ga/google-api-php-client/examples/analytics/demo/index.php';
const CLIENT_ID = '591513812464-peee4a6j60rs5k9qgpkla9kqdnmr8ihk.apps.googleusercontent.com';
const CLIENT_SECRET = 'jJv2fXlSMtSOzoB-MumoReUE';
...
<select name="webproperty-dd" >
	...
	if(isset($props['items']))
	{
		...
		if(!empty($props['items']))
		{
			...
			{
				 $props['items'][$i] = (array) $props['items'][$i] ;
		?>
