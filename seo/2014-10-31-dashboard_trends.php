...
<div id="Trends">
    ...
    <div id="heat_map_container" style="position:relative; padding-top:50px;">
    	<h6 style="position:absolute; left:0; top:0; width:97%;"><p class="SessionsbyYear" title="The yearly chart shows hot spots and gaps in your site traffic throughout the year.">Daily Sessions by Year</p>  <span style="right:-12px !important; width:87%;" class="year">&nbsp;</span></h6>
    	<div>
