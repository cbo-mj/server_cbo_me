                        ...
                        if(isset($_POST["submit"]))
                        {
                            ...
                            if(isset($_POST["type"]) and $_POST["type"]!="")
                            {
                                ...
                                if($date_sql==""){
									...
									$sql_icon = "select * from ga_icon_display where client_id = '$client_id' or client_id='' ";
									...
									$rs_icon = mysql_query($sql_icon) or die ( mysql_error() );	
                                    ...
                                    if($type=="yesterday") { 
										...
										$sql_icon = "select * from ga_icon_display where client_id = '$client_id' or client_id='' $date_sql";
                                    }else {
								 ...
								 if(mysql_num_rows($rs_icon)>0){   
                                    while($ga_icon_detail = mysql_fetch_assoc($rs_icon)){
                                        $icon_name[] = $ga_icon_detail['icon_name'];
                                        $icon_description[] = $ga_icon_detail['description'];
										$icon_date[] = $ga_icon_detail['date'];
										$icon_event_type[] = $ga_icon_detail['event_type'];
                                    }
                                }
