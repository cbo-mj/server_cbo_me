	...
	if(isset($_GET["type"]) and $_GET["type"]!="")
	{
		...
		}else if($type=="last_week")
		{
			$where = " date >= curdate() - INTERVAL DAYOFWEEK(curdate())+ 5 DAY
					 AND date < curdate() - INTERVAL DAYOFWEEK(curdate())- 2 DAY and " ;
					 
				$where_a = " a.date_a >= curdate() - INTERVAL DAYOFWEEK(curdate())+ 5 DAY
					 AND a.date_a < curdate() - INTERVAL DAYOFWEEK(curdate())- 2 DAY" ;
