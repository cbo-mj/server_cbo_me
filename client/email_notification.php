...
$sql = "SELECT * FROM email_notification ";
...
$message .= 'Delete email notification successfully';
...
<head>
<title>Email Notification List</title>
...
<div style="position:relative; top:22px; left:135px;" ><strong>Email Notification List</strong></div>
...
<?php if(isset($message)) { echo $message ; }?>
                    ...
                    <a style="position: relative;left: 868px;" href="add_email_notification.php">Add Email Notification</a>
                        <table id="call_tracking_record" class="display"  width="100%" style="border-left:1px solid #dbdbda; border-bottom:1px solid #dbdbda;">
                           ...
                           <tr>
                                     ...
                                     <th>
										<?php 
                                           if($row['service_id'] !="")
                                           {
                                            ...
                                            $rs_service = mysql_query($sql_service) or die ( mysql_error() );							
                                            if(mysql_num_rows($rs_service) > 0 )
                                            {
                                                $service_detail = mysql_fetch_assoc($rs_service);
                                   ...
                                   if($row['client_id'] !="")
								   {
                                    ...
                                    <th><a href="edit_email_notification.php?id=<?php echo $row['notification_id'];?>">Edit</a></th>
                                    <th><a href="delete_email_notification.php?id=<?php echo $row['notification_id']?>">Delete</a></th>  
