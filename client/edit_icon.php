...
$sql_query = "SELECT * FROM ga_icon_display WHERE icon_id = '$id' ";
...
if(isset($_POST["submit"]))
{
	...
	if(empty($error))
	{
		...
		// not need to insert	and send mail		
			 $sql_insert = "update ga_icon_display set
							icon_name = '$icon_name',
							date = '$date',
							client_id = '$client_id',
			...
			$_POST ='';
			$msg = "Icon has been update successfully";
   ...
   <h3 style="color:black;"> <?php if(isset($msg)){echo $msg;} ?></h3>
	 ...
	 while($client_detail = mysql_fetch_assoc($rs_client))
	 {
		 ...
		 {	
		 	$selected_acc = 'selected="selected"';
			  ...
			  if($client_detail["client_id"]==$row['client_id'])
		 	{	
		 		$selected_acc = 'selected="selected"';
	...
	?>	
       ...
       <tr>
            ...
            <td><input type="text" name="date" id="date" value="<?php if($_POST["date"]){ echo $_POST["date"];}else{ echo $row['date'];} ?>" />
            <br/>
	...
	?>	
     ...
     <br/>
       ...
       <tr>
            ...
            <td><input type="text" name="icon_name" id="icon_name" value="<?php if($_POST["icon_name"]){ echo $_POST["icon_name"];}else{ echo $row['icon_name'];} ?>" />
            <br/>
        ...
        <tr>
            ...
            <textarea style="height:100px; width:300px;" type="text" name="description" id="description"><?php if($_POST["description"]){ echo $_POST["description"];}else{ echo $row['description'];}  ?></textarea>
            <br/>
