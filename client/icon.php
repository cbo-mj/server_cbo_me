...
$sql = "SELECT * FROM ga_icon_display ";
...
$message .= 'Delete icon successfully';
...
<div style="position:relative; top:22px; left:135px;" ><strong>Icon List</strong></div>
...
<?php if(isset($message)) { echo $message ; }?>
                    ...
                    <a style="position: relative;left: 868px;" href="add_icon.php">Add Icon</a>
                        <table id="call_tracking_record" class="display"  width="100%" style="border-left:1px solid #dbdbda; border-bottom:1px solid #dbdbda;">
                           ...
                           <tr>
                                   ...
                                   if($row['client_id'] !="")
								   {
                                    ...
                                    <th><a href="edit_icon.php?id=<?php echo $row['icon_id'];?>">Edit</a></th>
                                    <th><a href="delete_icon.php?id=<?php echo $row['icon_id']?>">Delete</a></th>  
