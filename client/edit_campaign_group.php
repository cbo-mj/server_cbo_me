...
UNION  
SELECT distinct 0 as `campaign_id`, 'Not Set' AS `campaign_name`, 'Enabled' AS campaign_state FROM `campaign_event_history` WHERE `account_id`='$account_id' AND `profile_id`='$profile_id' AND `adwordsCampaignID`=0";
