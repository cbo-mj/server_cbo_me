		...
		return this.each(function()
		{
			...
			if ($input.children('optgroup').length == 0)
			{
				$input.children().each(function(i)
				{
				   ...
				   if(rel){
					$newUl.append($('<li><a href="'+rel+'">'+option+'</a></li>').data('key', key));
				   }else{
			...
			else //optgroup
			{
				$input.children('optgroup').each(function()
				{
					...
					$(this).children().each(function()
					{
						...
						if(rel){
						$optGroupList.append($('<li><a href="'+rel+'">'+option+'</a></li>').data('key',key));
					 }else{
			...
			$(window).bind('resize.sSelect scroll-y.sSelect', newUlPos);
