						...
						$rs_call_log = mysql_query($sql) or die ( mysql_error() );
							...
							?>
                                ...
                                <tr class="odd">
                                    ...
                                    <a href="campaign_group_list.php?id=<?php echo $row["id"]; ?>&client_id=<?php echo $row["client_id"]; ?>&phone_number=<?php echo $row["phone_number"]; ?>">Campaign Group List</a> &nbsp;&nbsp; &nbsp;&nbsp;
								...
								if(mysql_num_rows($rs_call_log)>0)
								{
                                  ...
                                  <tr class="odd">
                                   ...
                                   <td><?php echo $row_more["destination_number"]; ?></td>
									...
									<!--
									<a href="campaign_group_list.php?id=<?php echo $row_more["id"]; ?>&client_id=<?php echo $row_more["client_id"]; ?>&phone_number=<?php echo $row_more["phone_number"]; ?>">Campaign Group List</a> &nbsp;&nbsp; &nbsp;&nbsp;-->
