...
<div style="position:relative; top:22px; left:135px;" ><strong>Service List</strong></div>
...
<?php if(isset($message)) { echo $message ; }?>
                    ...
                    <a style="position: relative;left: 868px;" href="add_service.php">Add Service</a>
                        <table id="call_tracking_record" class="display"  width="100%" style="border-left:1px solid #dbdbda; border-bottom:1px solid #dbdbda;">
                           ...
                           <tr>
                                    ...
                                    <th><a href="edit_service.php?id=<?php echo $row['service_id'];?>">Edit</a></th>
                                    <th><a href="delete_service.php?id=<?php echo $row['service_id']?>">Delete</a></th>  
