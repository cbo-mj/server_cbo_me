...
class gapi
{
 ...
 // const report_data_url = 'https://www.google.com/analytics/feeds/data';
  ...
  public function requestReportData($report_id, $dimensions, $metrics, $sort_metric=null, $filter=null, $start_date=null, $end_date=null, $start_index=1, $max_results=30)
  {
	...
	//$parameters['key'] = 'AIzaSyBUAjDj21BpP5GP4lMa3ZhzOZ61KO19ia0';  // This is for the the google@cbo.me account
	
	$parameters['key'] = 'AIzaSyAMJ-HPZKRSuIxiPqZ_bm1gOeCFwy8vrtg'; // this is for the google2@cbo.me ACCOUNT
  ...
  protected function authenticateUser($email, $password)
  {
    $post_variables = array(
      ...
      'Email' => $email,
      'Passwd' => $password,
	 // 'setDeveloperKey'=>'AIzaSyBUAjDj21BpP5GP4lMa3ZhzOZ61KO19ia0',  // This is for the the google@cbo.me account
	// 'setDeveloperKey'=>'AIzaSyAMJ-HPZKRSuIxiPqZ_bm1gOeCFwy8vrtg', // this is for the google2@cbo.me ACCOUNT
