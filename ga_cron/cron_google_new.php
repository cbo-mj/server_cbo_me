...
for($i=0; $i<sizeof($login_detail); $i++)
{
	...
	{
			echo $ga_profile_id = $row['profile_id'];
			echo $ga_account_id = $row['account_id'];
			...
			//get_30_days_for_category_event_queryCoreReportingApi($ga,$startDate_before_30_days,$endDate_before_today,$startIndex,$maxResults,$ga_profile_id,$ga_account_id);
			
			//	get_30_days_for_category_event_queryCoreReportingApi($ga,$startDate_before_30_days,$endDate_before_today,$startIndex,$maxResults,$ga_profile_id,$ga_account_id);
			
			// usleep(100000); //depends the number of request/user/second you specify in console
			
			
			
		//	get_365_days_for_category_event_queryCoreReportingApi($ga,$startDate_before_30_days,$endDate_before_today,$startIndex,$maxResults,$ga_profile_id,$ga_account_id);
