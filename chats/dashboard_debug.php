                            ...
                            <div class="doughnut_charts">
                                <div class="doughnut_items_wrap">
                                	<div class="total_call_wrap doughtnut">
                                        ...
                                        <h5><p class="Prospectss" title="The number of click on your ads.">Prospects</p></h5>
                                    </div>
                                    <div class="total_call_wrap doughtnut">
                                        ...
                                        <h5><p class="Leadss" title="The number of click on your ads.">Leads</p></h5>
                                    </div>
                                    <div class="nonbillable doughtnut">
                                        ...
                                        <h5><p class="NonBillables" title="The number of click on your ads.">Non Billable</p></h5>
                                    </div>
                                    <div class="ans_call_wrap1 doughtnut">
                                        ...
                                        <h5><p class="LeadPercentages" title="The number of click on your ads.">Lead Percentage</p></h5>
                                        ...
                                        <label>
    										...
    										?></label>
                                        <h5><p class="AvgChats" title="The number of click on your ads.">Avg. Chat Session (min)</p></h5>
                                    </div>
                                </div>
                                <div class="clearB"></div>
                                <div class="clearB"></div>
                            <?php include('linechartChat2.php'); ?> 
