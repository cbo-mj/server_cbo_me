                            ...
                            <div class="doughnut_charts">
                                <div class="doughnut_items_wrap">
                                	<div class="total_call_wrap doughtnut">
                                        ...
                                        <div class="doughnut-img-wrap"><img src='icons/prospect-icon.png' /></div>
                                        <label><?php echo $prospect_f; ?></label>
                                        <h5>Prospects</h5>
                                    </div>
                                    <div class="total_call_wrap doughtnut">
                                        <div id="leads" style="width: 100%; height: 120px; background-color: #FFFFFF;" ></div>
                                        <div class="doughnut-img-wrap"><img src='icons/leads-icon.png' /></div>
                                    ...
                                    <div class="ans_call_wrap1 doughtnut">
                                        ...
                                        <div class="doughnut-img-wrap"><img src='icons/leads2-icon.png' /></div>
                                    ...
                                    <div class="nonbillable doughtnut">
                                        ...
                                        <div class="doughnut-img-wrap"><img src='icons/non-billable-icon.png' /></div>
                                        <label><?php echo $lead_perc; ?></label>
                                        <h5>Non Billable</h5>
                                    </div>
                                    <div class="avg_call_wrap1 doughtnut">
                                        <div id="sessionTime" style="width: 100%; height: 120px; background-color: #FFFFFF;" ></div>
                                        <div class="doughnut-img-wrap"><img src='icons/session-time-icon.png' /></div>
                                        <label>
...
<?php 
		//$i=0;
		//foreach ($date_line as $date_line_value) {
       
			//echo    $date_line_value." : ".$prospect_line[$i]." : ".$leads_line[$i]." : ".$non_bilable_line[$i]."</br>" ;
	   		//$i++;
		//}
...
?>                              <?php include('linechartChat.php'); ?> 
                        ...
                        <table id="call_tracking_record" class="display"  width="100%" style="border-left:1px solid #dbdbda; border-bottom:1px solid #dbdbda;">
							...
							<tr class="odd">
							    ...
							    <td>
                                   <a href="#modal_<?php echo $i;?>" class="inline<?php echo $i;?>" onClick="return close_open_model2('modal_<?php echo $i;?>');" data-reveal-id="modal_<?php echo $i;?>"><img src="icons/info_btn.png" /></a>
                             	</td>
							</tr>
							<?php endforeach; ?>
				        </tbody>
...
<div style="display:none;" >
    <div id="modal_" class="item_modals">
   	<!--<div align="right">
 	<a href="#"  onClick="return close_open_model('modal_<?php //echo $i;?>','<?php //echo $caller_id;?>');">Close</a>
	</div>-->

	<h1 class="item-title">Leads</h1>
       <table width="100%" >
            <tbody>
                <tr>
                    <td align="right"><b>Date and Time</b></td>
                    <td align="left"><!--5th May ‘14 - 11:51:22--><?php //echo $date_prefix; echo date(" M 'y - H:i:s",strtotime($date));?></td>
                </tr>
                <tr>
