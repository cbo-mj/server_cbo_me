...
@media only screen and (min-device-width:1280px) and (max-device-width:1366px){
	/*.tbl_foot_rec_length select { background:url(../Images/bg-select-arrow.png) no-repeat scroll 34px -1px #fff !important;
		float:left;
		height:22px;
...
@media only screen and (min-device-width:800px) and (max-device-width:1500px){
	/*.tbl_foot_rec_length select {
		background:url(../Images/bg-select-arrow.png) no-repeat scroll 34px -1px #fff !important;
		float:left;
		height:22px;
		font:12px "Segoe UI",Arial,sans-serif!important;
		margin:0;
