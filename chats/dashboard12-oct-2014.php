...
if($_GET["search"])
{
	if(isset($_GET["type"]) and $_GET["type"]!="")
	{
		...
		if($type=="today"){
			...
			/*$where = "WHERE createdOn >= curdate() - INTERVAL DAYOFWEEK(curdate())+ 4 DAY
				 AND createdOn < curdate() - INTERVAL DAYOFWEEK(curdate()) - 3 DAY ";*/
                            ...
                            <div class="doughnut_charts">
                                <div class="doughnut_items_wrap">
                                    ...
                                    <div class="nonbillable doughtnut">
                                        ...
                                        <h5><p class="NonBillables" title="Number of non charged leads.">Non Billable</p></h5>
                                    </div>
