...

	{
...

		{
            ...
            $where = "where 
				...
				createdOn between '$from_date' AND '$to_date' " ;			
...
$rs_lead_summary = mysql_query($sql_summary) or die ( mysql_error() );	
	...
	$i=0;
	pr($chat_start_dtm); die;
	foreach ($date as $date_value) {
       
	echo    $date_value." : ".$chat_start_dtm[$i]." : ".$chat_duration[$i]." : ".$city." ".$state." ".$country." : ".$chat_lead_status[$i]." : ".$notes[$i]."</br>" ;
	   $i++;
}
