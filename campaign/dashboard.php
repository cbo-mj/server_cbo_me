...
include("include/common_function.php");
  ...
  $sql_camp_link = "select * from group_campaign_link where  client_id = '$client_id' and campaign_type = '3' ";
...
// pr($campaign_id_link);
 ...
 if(!empty($campaign_id_link))
 {
		...
		if($campaign_id_link!="")
		{
			$campaign_id_new = $campaign_id_link;
		}
 ...
 if($campaign_id_new=="")
 {
	...
	die;
	//die("Please contact admin to set Campaign campaign-group for the client $client_name"); 
 }
...
SELECT `group_campaign_id` as campaign_id,`campaign_name` FROM group_campaign WHERE client_id = '$client_id' and campaign_type = '3' ";
