...
<!--							foreach ($impression as $impression_value) {
						...
						<iframe id="chartfunnel" src="http://server.cbo.me/sem/final_funnel_trend.php?id=<?php echo $target_number; ?>&click=<?php echo $click[0]; ?>&impression=<?php echo $impression_value; ?>&event=<?php echo $event[0]; ?>" ></iframe>                 
                       	<style>
