...
AmCharts.makeChart("EventsChart",
		{
			...
			"brightnessStep": 163.2,
			"colorField": "Not set",
			<?php if($sum_TotalEvent != 0){
				echo '"colors": ["#3c84da","#e6e6e6"],';
			}else{
				echo '"colors": ["#e6e6e6","#3c84da"],';
			} ?>			
			"labelTickAlpha": 0,
			"maxLabelWidth": 214,
			"outlineThickness": 7,
			...
			"dataProvider": [
			<?php if($sum_TotalEvent != 0){
				echo '{"tittle": "Clicks", "value": '.$sum_TotalEvent.'}';
			}else{
				echo '{"tittle": "Clicks", "value": 100}';
			} ?>				
			]
		}
	),
AmCharts.makeChart("CallsChart",
		{
			...
			"brightnessStep": 163.2,
			"colorField": "Not set",
			<?php if($sum_total_call != 0){
				echo '"colors": ["#e479c7","#e6e6e6"],';
			}else{
				echo '"colors": ["#e6e6e6","#e479c7"],';
			} ?>
			"labelTickAlpha": 0,
			"maxLabelWidth": 214,
			"outlineThickness": 7,
			...
			"dataProvider": [
			<?php if($sum_total_call != 0){
				echo '{"tittle": "Calls", "value": '.$sum_total_call.'}';
			}else{
				echo '{"tittle": "Calls", "value": 100}';
			} ?>						
			]
		}
	),
