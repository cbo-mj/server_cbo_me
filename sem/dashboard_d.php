...
include("include/common_function.php");
 ...
 if($campaign_id==""){
	die("Please contact admin to set SEM campaign-group for the client $client_name"); 
 }
?>
...
<style>
	...
	*/span.ImpressionsChart:hover, span.Clicks:hover, span.Events:hover, span.Calls:hover, span.CustomerEngagement:hover{ cursor:help;}
	...
	.content6{background-position: 0 42px;}	
...
<div class="piechart"> 
	...
	<h6><p class="CustomerEngagement" title="The percentage of users who clicked <br />on ad and then performed an action.">Customer Engagement</p></h6>
</div>
<div style="clear:both;"></div>
<br />


<?php include('stockchart_sem1.php'); ?>
<div style="clear:both;"></div>
