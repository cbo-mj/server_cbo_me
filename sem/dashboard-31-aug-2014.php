...
if(isset($_POST["submit"]))
{
	...
	if(isset($_POST["type"]) and $_POST["type"]!="")
	{
		...
		{
			echo "Date : Impressions : Clicks : Click to Call Ratio : Total Event : Total call"."</br>";
			...
			while($ga_30_days_detail = mysql_fetch_assoc($rs_30_days))
			{
				...
				echo $TotalEvent = $ga_30_days_detail['totalEvents'];
				echo $total_call = $ga_30_days_detail['total_call']."</br>";
		...
		if(mysql_num_rows($rs_30_days)>0)
		{
			...
			while($ga_30_days_detail = mysql_fetch_assoc($rs_30_days))
			{
				...
				echo $adClicks = $ga_30_days_detail['adClicks'];  echo "  :  ";
				echo $CTR = $ga_30_days_detail['CTR'];  echo "  :  ";
				echo $TotalEvent = $ga_30_days_detail['totalEvents'] ; echo "  :  ";
				echo $Totalcall = $ga_30_days_detail['total_call']."</br>";
