...
/*$result = $authlabs->priorityPartnerKeyword("business relocation", 'abr.net.au', $auth_token, "google", "en-US", "false", $callback_url);
*/


$keyword = "business relocation";
$url =  "server.cbo.me/partner_api/live.php";

$json_url = 'http://api.authoritylabs.com/keywords/get.json?keyword=business+ relocation&engine=google&pages_from=false&lang_only=false&geo=&autocorrect=';


//$json_url = 'https://whiteseo795.ala.bs/keywords/get.json?keyword=<strong>vuurr</strong>&engine=google&pages_from=false&lang_only=false&geo=&autocorrect=';

$domain_url = "abr.net.au";
$result = $authlabs->parseRanks($domain_url, $json_url, $auth_token);

/*$result = $authlabs->getPartnerKeyword($keyword, $url, $auth_token, $engine = "google", $locale = "en-US", $pages_from = "false");
*/
...
//$url = 'https://whiteseo795.ala.bs/keywords/get.json?keyword=vuurr&rank_date=2014-01-09&locale=en-us&engine=google&pages_from=false&lang_only=false&geo=&autocorrect=';
