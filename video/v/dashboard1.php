							...
							<tr class="odd" role="row">
                                ...
                                <td>
                                    <span class="btn-links">
                                        <a href="<?php echo URL_SITE?>/play.php?video_key=<?php echo $video['key'] ?>&tag=<?php echo $tag?>">View</a>&nbsp;|&nbsp;<a href="<?php echo URL_SITE.'/listing.php'.$querystring.'&key='.$video['key']?>" onclick="return confirm('Are you sure to delete this video?')">Delete</a>
                                    </span>                                
                                </td>
							</tr>
                        <?php
