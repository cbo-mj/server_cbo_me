...
<!-- BEGIN OF NEW DROPDOWN FORM -->
                                                ...
                                                <style>
													...
													.option{ width:265px; margin: 15px 0 18px 88px;}
													.option p{ font:bold 12px/1 Arial, Helvetica, sans-serif; width:76px; display:inline;}
                                                	h2#nav { margin-left:10px; border-radius:2px; width: 186px; color:#000000; line-height: 25px; font-size: 14px; padding: 5px 5px 5px 10px; cursor: pointer; border:1px solid #d3d3d3; font:12px/1 Arial, Helvetica, sans-serif; display:inline-block; text-transform:uppercase; background:url(arrow-down.png) no-repeat right center;}
