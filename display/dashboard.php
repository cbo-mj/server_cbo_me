...
include("include/common_function.php");
	...
	$sql_camp_link = "select * from group_campaign_link where  client_id = '$client_id' and campaign_type = '1' ";
 ...
 if($campaign_id=="")
 {
	...
	die();
	//die("Please contact admin to set DISPLAY campaign-group for the client $client_name"); 
 }
...
<?php endif; ?>
	...
	.piechart h6{ font-size:16px; line-height:22.4px;}
