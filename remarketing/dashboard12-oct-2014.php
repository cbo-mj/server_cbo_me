...
<div id="wrapper">
                        ...
                        if($_POST["webproperty-dd"]!=""){
                        	if(isset($_POST["type"]) and $_POST["type"]!=""){
                        		...
                        		if($type=="today"){
                                	...
                                	$date_sql = " and ga.date >= curdate() - INTERVAL DAYOFWEEK(curdate())+6 DAY AND ga.date < curdate() - INTERVAL DAYOFWEEK(curdate())-1 DAY	";
	...
	`					<div id="main_container">
                            ...
                            <div class="piechart"> 
                                ...
                                <h6><span class="Calls" title="The number of calls directly from your ads.">CTR</span></h6>
                            </div>
                            <div class="piechart"> 
