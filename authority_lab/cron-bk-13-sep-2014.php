		...
		if(!empty($domain_list))
			{
				...
				for($d=0;$d<$sized;$d++)
				
					{
						...
						WHERE group_id = '$group_id' and domain_id = '$domain_id' and url ='$url' ";
						...
						= "INSERT INTO authority_lab_domain SET
						...
						= "INSERT INTO authority_lab_domain_tag SET
						...
						= "INSERT INTO authority_lab_domain_engine SET
...
print_r($keywords_list);*/ 	
				...
				if(!empty($keywords_list))
			{
				  ...
				  for($k=0;$k<$sizek;$k++)
					...
					$keywords_id = $keywords_list['keywords'][$k]['id'];
					$name = $keywords_list['keywords'][$k]['name'];
					$domain_id = $keywords_list['keywords'][$k]['domain_id'];
					$is_new_keyword = $keywords_list['keywords'][$k]['is_new_keyword'];
					$total_words = $keywords_list['keywords'][$k]['total_words'];
					$volume = $keywords_list['keywords'][$k]['volume'];
					...
					$sql_check = "
						...
						WHERE group_id = '$group_id' and domain_id = '$domain_id' and keywords_id ='$keywords_id' ";
						...
						= "INSERT INTO authority_lab_keywords SET
						...
						";
                          ...
                          mysql_query($authority_lab_keywords) or die ( mysql_error() ) ;
...
//---------curl to fetch the domains ranks-----------------------------------//		  
				 ...
				 $request_url = "$domain_url/api/ranks?keyword_id=$keywords_id&rank_date=2014-04-05";
$ch = curl_init();
curl_setopt($ch, CURLOPT_GET, 1);
        ...
        if(!empty($ranks_list))
			     {
				  ...
				  $sizer = count($ranks_list["ranks"]);
					...
					$sql_check = "
						...
						WHERE group_id = '$group_id' and domain_id = '$domain_id' and keywords_id ='$keywords_id' and rank_id='$rank_id' ";
					...
					foreach($google_ranks as $google_ranks_value)
						...
						= "INSERT INTO authority_lab_ranks_google_engine SET
